...
const InfoRow = ({ icon, label }: { icon: JSX.Element; label: React.ReactNode }) => (
...
export const TeacherCard = ({ teacher, onEdit, onDelete }: TeacherCardProps) => {
     return (
    <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 text-xs text-gray-500">
        <span>Works since: {new Date(teacher.startWorkDate).toLocaleDateString()}</span>
