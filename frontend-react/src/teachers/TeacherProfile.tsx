...
export const TeacherProfile = () => {
    ...
    const { data: teacher, isLoading, isError, error } = useGetTeacherById(teacherId);
  ...
  if(!teacher) {
        return <div className="text-center mt-10">Could not load teacher's data.</div>; 
  }
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
            <svg className="w-5 h-5 text-gray-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0v5.5M3 10l9 5 9-5M3 10v5.5"></path></svg>            <span className="font-semibold text-gray-700">Education:</span>
            <span className="ml-2 text-gray-900">{teacher.education}</span>
          </div>

            <div className="flex items-center">
            <svg className="w-5 h-5 text-gray-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>            <span className="font-semibold text-gray-700">Start work date:</span>
            <span className="ml-2 text-gray-900">{new Date(teacher.startWorkDate).toLocaleDateString()}</span>
          </div>

             <div className="flex items-center">
            <svg className="w-5 h-5 text-gray-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm9-1a2 2 0 100-4 2 2 0 000 4z"></path></svg>            <span className="font-semibold text-gray-700">Position:</span>
            <span className="ml-2 text-gray-900">{teacher.isHeadTeacher ? 'Head Teacher' : 'Teacher'}</span>
          </div>
