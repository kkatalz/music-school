...
export const StudentProfile = () => {
  ...
  if (!student) {
    return (
      <div className="text-center mt-10">Could not load student's data.</div>
    );
  }
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-gray-900">{Number(studyYears) + 1}</span>
          </div>
        </div>
      </div>
